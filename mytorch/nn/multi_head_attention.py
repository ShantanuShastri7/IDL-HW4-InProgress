...
class MultiHeadAttention:
    ...
    def _merge_masks(self, key_padding_mask, attn_mask):
        ...
        attention_mask = np.reshape(attn_mask, (1, 1, self.L, self.S))
    ...
    def _split_heads(self, x):
        ...
        x = np.reshape(x, (self.N, x.shape[1], self.num_heads, self.E // self.num_heads))
    ...
    def _concat_heads(self, x):
        ...
        x = np.reshape(x, (self.N, self.L, self.E))
