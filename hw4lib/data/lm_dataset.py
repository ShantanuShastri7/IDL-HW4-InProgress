...
class LMDataset(Dataset):
    ...
    def __init__(
        ...
        self.text_dir = self.text_dir = os.path.join(config['root'], partition)
        ...
        for file in tqdm(self.text_files):
            ...
            char_codes = np.load(file).tolist() 

            # 2. Convert the list of integer codes into a single string.
            transcript = ''.join(char_codes)
