...
class EncoderDecoderTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.enc_layers = nn.ModuleList([
            SelfAttentionEncoderLayer(d_model, num_encoder_heads, dropout)
    ...
    def encode(self, padded_sources: torch.Tensor, source_lengths: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, dict]:
        ...
        # x_enc is now SHORTER than padded_sources due to time reduction
        ...
        # --- FIX START ---
        # Create source padding mask using the REDUCED representation (x_enc) 
        # and REDUCED lengths (x_enc_lengths)
